...
const STRINGS = {
  ...
  fr: {
    ...
    'home.cyc_pms_body': "L\u2019energie baisse souvent les jours d\u2019avant, et la concentration avec. Autant avancer la grosse tache cette semaine et garder l\u2019administratif leger pour la suivante.",
    ...
    'home.cyc_period_body': "Des blocs courts marchent souvent mieux que des longs cette semaine. Faire une vraie chose, c\u2019est une journee complete, pas une journee au rabais.",
    'home.cyc_fertile_title': "Milieu de cycle",
    'home.cyc_fertile_body': "En general la periode ou l\u2019energie et la concentration se trouvent le plus facilement. Bonne semaine pour lancer ce que tu repousses.",
    'diag.title': 'Achats',
    ...
    'cycle.close': 'Fermer',
    'cycle.history': 'Regles enregistrees',
    ...
    'cycle.avg_range': 'Pas enregistre : il faut entre {min} et {max} jours.',
    ...
    'cycle.logged': "Aujourd\u2019hui est enregistre.",
    ...
    'cycle.care_fertile': "Milieu de cycle. En general la periode ou l\u2019energie se trouve le plus facilement.",
