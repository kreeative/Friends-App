...
const STRINGS = {
  en: {
    ...
    'proof.empty': 'No proof yet. Attach one on a goal card when you answer it, and it turns up here.',
  ...
  fr: {
    ...
    'proof.empty': "Pas encore de preuve. Ajoutes-en une sur la carte d'un objectif quand tu reponds, et elle apparait ici.",
