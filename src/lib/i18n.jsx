...
const STRINGS = {
  en: {
    ...
    'cycle.avg_manual': 'Average cycle length, in days',
    ...
    'cycle.started_today': 'Started today',
  ...
  fr: {
    ...
    'cycle.avg_manual': 'Duree moyenne du cycle, en jours',
