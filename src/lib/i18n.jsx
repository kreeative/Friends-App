...
const STRINGS = {
  ...
  fr: {
    ...
    'cal.today': "Aujourd'hui", 'cal.prev': 'Precedent', 'cal.next': 'Suivant',
    ...
    'wiz.err_order': '{what} : ca doit finir apres avoir commence.',
    ...
    'recap.cycle': 'Cycle',
    'home.cyc_pms_title': "Tes regles approchent",
    ...
    'diag.title': 'Achats',
    'diag.body': "Si un livre a ete paye et n'est pas arrive, ceci verifie toute la chaine : les cles de ce deploiement, si Stripe sait ou envoyer un paiement termine, si les paiements recents ont bien ete livres, et si les acces peuvent etre enregistres. Aucun secret n'est affiche.",
    'diag.run': 'Verifier les achats',
    'diag.running': 'Verification...',
    'diag.detail': 'Tout ce qui a ete trouve',
    ...
    'cycle.setup_title': 'Tes dernieres regles',
    ...
    'cycle.save_failed': 'Ca n’a pas ete enregistre. Reessaie.',
    ...
    'cycle.stale_one': 'Des regles semblent non enregistrees, la prevision a derive.', 'cycle.stale_other': '{n} cycles semblent non enregistres, la prevision a derive.',
    'cycle.need_more': 'Enregistre un debut de regles et le calendrier pourra estimer.',
    ...
    'cycle.phase_pms': 'Avant les regles', 'cycle.phase_fertile': 'Periode fertile',
    ...
    'studies.cycle_eyebrow': 'Article',
    'studies.cycle_title': 'Les regles ne sont pas un detail prive',
    'studies.cycle_sub': "Ca arrive tous les mois et ca change ce qu'une semaine permet. Le seul truc prive, c'est le silence.",
