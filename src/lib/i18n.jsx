...
const STRINGS = {
  en: {
    ...
    'board.feed': 'Recently',
    'proof.tab': 'Proof',
    'proof.title': 'Instants',
    'proof.sub': 'What the group actually did.',
    'proof.add': 'Add a photo',
    'proof.remove': 'Remove the photo',
    'proof.visible': 'Everyone in the group can see this.',
    ...
    'proof.empty': 'No photos yet. Add one to a goal when you check in and it lands here.',
  ...
  fr: {
    ...
    'proof.add': 'Ajouter une photo',
    'proof.remove': 'Retirer la photo',
    'proof.visible': 'Tout le groupe peut la voir.',
    ...
    'proof.empty': 'Aucune photo. Ajoutes-en une à un objectif quand tu fais le point et elle arrive ici.',
