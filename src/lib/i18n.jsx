...
const STRINGS = {
  en: {
    ...
    'cal.layer_reservations': 'Bookings',
    'cal.join': 'Join',
    'cal.open_booking': 'Open in Cal',
    'cal.connect_section': 'Bookings from Cal.com',
    'cal.connect_what': 'Bookings taken on your Cal.com pages appear on your calendar, and tapping one opens the call. Nothing is stored here but the event type, the first name of whoever booked, and the times.',
    'cal.connect_start': 'Connect Cal.com',
    'cal.connect_step_url': '1. In Cal.com, open Settings, Developer, Webhooks, and paste this as the subscriber URL',
    'cal.connect_step_secret': '2. Paste this in the same form, as the secret',
    'cal.connect_step_events': '3. Tick these events, and save',
    'cal.connect_events_list': 'Booking created, Booking rescheduled, Booking cancelled.',
    'cal.connect_copy': 'Copy',
    'cal.connect_copied': 'Copied',
    'cal.connect_waiting': 'Nothing has come through yet. The first booking will land here on its own.',
    'cal.connect_live': 'Working. Last heard from Cal.com on {when}.',
    'cal.connect_stop': 'Disconnect',
    'cal.connect_failed_connect': 'That did not save. This needs the database: run supabase/72_cal_bookings.sql in Supabase.',
    'cal.connect_failed_disconnect': 'Nothing was removed, so Cal.com can still write here. Try again.',
    'cal.connect_failed_copy': 'Your browser would not let the page copy. Select the text above instead.',
    ...
    'diag.check_books': 'Why a book will not open',
    ...
    'cycle.since_days': 'Day {n} since your last period started.',
    'cycle.started_today': 'Your period started today.',
    'cycle.measured_on': 'Based on {n} measured cycles.',
    'cycle.need_three': 'Not enough recorded yet to predict anything.',
    'cycle.need_three_why': 'Three dates make two measured cycles, which is about the least that makes an average mean something. Record your last few and this starts working.',
    'cycle.go_record': 'Record my periods',
    'cycle.manage': 'My cycle',
    'cycle.close': 'Close',
    'cycle.history': 'Recorded periods',
    'cycle.edit_date': 'Change this start date',
    'cycle.add_past': 'Add a date I missed',
    'cal.add_period': 'My period',
    'cal.add_period_save': 'Record it',
    /* Dit ce qu'on FAIT, pas ce que l'ecran est. "Choisis des jours" laisse
       ouverte la question de comment, et la reponse est de toucher la grille. */
    'cal.pick_how': 'Tap the days you bled. Tap again to undo one.',
    'cal.pick_n_one': '1 day selected', 'cal.pick_n_other': '{n} days selected',
    'cal.pick_saved_one': 'Saved. 1 period recorded.',
    'cal.pick_saved_other': 'Saved. {n} periods recorded.',
    'cal.pick_removed_one': 'Saved. 1 period removed.',
    'cal.pick_removed_other': 'Saved. {n} periods removed.',
    'cycle.add_past_label': 'The day that period started',
    'cycle.add_past_cancel': 'Cancel',
    'cycle.added': 'Added to your history.',
    'cycle.already': 'That day was already recorded.',
    ...
    /* La carte du haut: un nombre, son unite, et la date. "Dans 28 jours"
       oblige a compter sur un calendrier; la date, non. */
    'cycle.today_big': 'Today',
    'cycle.away_unit_one': 'day to go', 'cycle.away_unit_other': 'days to go',
    'cycle.late_unit_one': 'day late', 'cycle.late_unit_other': 'days late',
    'cycle.expected_on': 'Expected {date}',
    'cycle.gap_one': '{n} day later', 'cycle.gap_other': '{n} days later',
    ...
    'notif.nudge_by': '{who} is asking after you',
    'notif.nudge_anon': 'Someone in your group is asking after you',
    'notif.nudge_sub': 'It has been a while. Nothing to do, it is just a wave.',
    /* The answer, and the row it produces on the other side. */
    'notif.reply_cta': 'Let them know I am fine',
    'notif.reply_sending': 'Sending',
    'notif.reply_done': 'They have been told.',
    'notif.reply_by': '{who} is doing fine',
    'notif.reply_anon': 'They are doing fine',
    'notif.reply_sub': 'They saw that you were asking after them.',
    ...
    'goal.backfill_hint': 'Tap a past day to add it, or tap again to take it back.',
    'goal.mark_on': 'Mark {date}',
    'settings.sticker_change': 'Change the picture',
    'settings.sticker_close': 'Done',
    'settings.sticker_auto': 'Pick for me',
    'settings.sticker_pick': 'Pick {name}',
    'settings.sticker_pending': 'This needs migration 66 before a picture can be saved.',
    ...
    'water.of': 'of {total}',
    'update.now': 'Update to the new version',
    ...
    'courses.sub': 'Money, taught in the order it is actually learned.',
    ...
    'me.water_off': 'The water reminder is off, so nothing is being counted. Turning it on puts a glass counter here and on your home screen.',
    'me.water_turn_on': 'Turn on the water reminder',
    ...
    'library.guest_paid_title': 'Paid. Your book is waiting.',
    'library.guest_paid_body': 'Create your account with the same email address you paid with, and the book opens straight away. It is held against that address until you do.',
    'library.guest_paid_cta': 'Create my account',
  ...
  fr: {
    ...
    'cal.layer_reservations': 'Réservations',
    'cal.join': 'Rejoindre',
    'cal.open_booking': 'Ouvrir dans Cal',
    'cal.connect_section': 'Les réservations Cal.com',
    'cal.connect_what': 'Les réservations prises sur tes pages Cal.com arrivent sur ton calendrier, et toucher l’une d’elles ouvre l’appel. Rien n’est gardé ici à part le type de rendez-vous, le prénom de qui a réservé, et les heures.',
    'cal.connect_start': 'Brancher Cal.com',
    'cal.connect_step_url': '1. Dans Cal.com, va dans Settings, Developer, Webhooks, et colle ceci comme subscriber URL',
    'cal.connect_step_secret': '2. Colle ceci dans le même formulaire, comme secret',
    'cal.connect_step_events': '3. Coche ces événements, et enregistre',
    'cal.connect_events_list': 'Booking created, Booking rescheduled, Booking cancelled.',
    'cal.connect_copy': 'Copier',
    'cal.connect_copied': 'Copié',
    'cal.connect_waiting': 'Rien n’est encore arrivé. La première réservation se posera ici toute seule.',
    'cal.connect_live': 'Ça marche. Dernière nouvelle de Cal.com le {when}.',
    'cal.connect_stop': 'Débrancher',
    'cal.connect_failed_connect': 'Ça n’a pas été enregistré. Il faut la base : exécute supabase/72_cal_bookings.sql dans Supabase.',
    'cal.connect_failed_disconnect': 'Rien n’a été retiré, donc Cal.com peut encore écrire ici. Réessaie.',
    'cal.connect_failed_copy': 'Ton navigateur a refusé la copie. Sélectionne le texte ci-dessus à la place.',
    ...
    'wiz.err_times': '{what} : mets un début et une fin, ou aucun des deux.',
    ...
    'home.cyc_predicted_title': "Prévu par ici",
    'home.cyc_predicted_body': "Un jour ou deux d’écart, c’est normal. Si tu peux, garde les prochains jours légers en échéances plutôt que de les empiler.",
    ...
    'diag.check_books': 'Pourquoi un livre ne s’ouvre pas',
    'diag.detail': 'Tout ce qui a été trouvé',
    'diag.local_only': "L'API a répondu {code} sans JSON. /api n'existe que sur le site déployé, pas sur un serveur de dev local.",
    'cycle.title': 'Cycle',
    'cycle.pitch': 'Suis tes règles et vois-les sur le calendrier, avec un rappel deux jours avant.',
    'cycle.private': 'Toi seule peux voir ceci. Ce n’est jamais partagé avec ton groupe.',
    'cycle.setup': 'Configurer',
    'cycle.setup_title': 'Tes dernières règles',
    'cycle.setup_help': 'Les dates de début des trois dernières, si tu t’en souviens. Une seule suffit pour commencer.',
    'cycle.date_oldest': 'Les plus anciennes (ex. il y a 2 mois)',
    'cycle.date_prev': 'Règles précédentes (ex. le mois dernier)',
    'cycle.date_recent': 'Règles les plus récentes (dernier cycle)',
    'cycle.avg': 'Durée moyenne du cycle, en jours (facultatif)',
    'cycle.since_days': 'Jour {n} depuis le début de tes dernières règles.',
    'cycle.started_today': 'Tes règles ont commencé aujourd’hui.',
    'cycle.measured_on': 'Calculé sur {n} cycles mesurés.',
    'cycle.need_three': 'Pas encore assez de dates pour prévoir quoi que ce soit.',
    'cycle.need_three_why': 'Trois dates font deux cycles mesurés, c’est à peu près le minimum pour qu’une moyenne veuille dire quelque chose. Note tes dernières et ça se met à marcher.',
    'cycle.go_record': 'Noter mes règles',
    'cycle.manage': 'Mon cycle',
    'cycle.close': 'Fermer',
    'cycle.history': 'Règles enregistrées',
    'cycle.edit_date': 'Modifier cette date de début',
    'cycle.add_past': 'Ajouter une date oubliée',
    'cal.add_period': 'Mes règles',
    'cal.add_period_save': 'Enregistrer',
    'cal.pick_how': 'Touche les jours où tu as saigné. Touche encore pour en retirer un.',
    'cal.pick_n_one': '1 jour sélectionné', 'cal.pick_n_other': '{n} jours sélectionnés',
    'cal.pick_saved_one': 'Enregistré. 1 règle notée.',
    'cal.pick_saved_other': 'Enregistré. {n} règles notées.',
    'cal.pick_removed_one': 'Enregistré. 1 règle retirée.',
    'cal.pick_removed_other': 'Enregistré. {n} règles retirées.',
    'cycle.add_past_label': 'Le jour où ces règles ont commencé',
    'cycle.add_past_cancel': 'Annuler',
    'cycle.added': 'Ajouté à ton historique.',
    'cycle.already': 'Ce jour était déjà enregistré.',
    'cycle.delete_entry': 'Supprimer cette entrée',
    'cycle.avg_manual': "Ton rythme habituel, en jours (environ 28)",
    'cycle.avg_help': 'Utilisée tant qu’il n’y a pas trois écarts mesurés, qui valent mieux qu’un souvenir.',
    ...
    'cycle.started_today': "C’est arrivé aujourd’hui",
    'cycle.started_today_on': "Démarrées aujourd’hui",
    'cycle.started_today_undo': "Appuyé par erreur ? Appuie encore pour retirer aujourd’hui.",
    'cycle.logged': "Aujourd’hui est enregistré.",
    'cycle.undone': 'Entrée supprimée.',
    'cycle.care_period': "Premier jour ou presque. Chaleur, eau, et rien que tu n’es pas obligée de faire.",
    'cycle.care_predicted': "Prévu par ici. Autant avoir ce qu’il te faut sous la main.",
    'cycle.care_pms': "La phase lutéale. Le repos n’est pas une récompense, c’est une partie du travail.",
    'cycle.care_fertile': "Milieu de cycle. En général la période où l’énergie se trouve le plus facilement.",
    'cycle.today_big': 'Aujourd’hui',
    'cycle.away_unit_one': 'jour restant', 'cycle.away_unit_other': 'jours restants',
    'cycle.late_unit_one': 'jour de retard', 'cycle.late_unit_other': 'jours de retard',
    'cycle.expected_on': 'Prévu le {date}',
    'cycle.gap_one': '{n} jour après', 'cycle.gap_other': '{n} jours après',
    'cycle.due_today': 'Prévu aujourd’hui.',
    'cycle.in_days_one': 'Prévu demain.', 'cycle.in_days_other': 'Prévu dans {n} jours.',
    'cycle.late_days_one': 'Un jour de retard sur la prévision.', 'cycle.late_days_other': '{n} jours de retard sur la prévision.',
    'cycle.cycle_len_one': 'cycle de {n} jour', 'cycle.cycle_len_other': 'cycle de {n} jours',
    'cycle.window_one': 'à un jour près', 'cycle.window_other': 'à {n} jours près',
    'cycle.conf_none': 'pas encore de données',
    'cycle.conf_low': 'approximatif, trop peu de dates',
    'cycle.conf_fair': 'approximatif, tes cycles varient',
    'cycle.conf_good': 'plutôt régulier jusqu’ici',
    ...
    'cycle.remind': 'Me prévenir avant',
    ...
    'cycle.disclaimer': 'Une estimation à partir de tes propres dates. Ni contraception, ni avis médical.',
    'cycle.phase_period': 'Règles', 'cycle.phase_predicted': 'Règles prévues',
    'cycle.phase_pms': 'Avant les règles', 'cycle.phase_fertile': 'Période fertile',
    'prep.water': 'Bois plus d’eau aujourd’hui.',
    'prep.warmth': 'Prépare quelque chose de chaud, une infusion ou une bouillotte.',
    'prep.gentle': 'Prévois quelque chose de plus doux que d’habitude.',
    'notif.title': 'Notifications',
    ...
    'notif.nudge_by': '{who} prend de tes nouvelles',
    'notif.nudge_anon': 'Quelqu’un du groupe prend de tes nouvelles',
    'notif.nudge_sub': 'Ca fait un moment qu’on ne t’a pas vu. Rien a faire, c’est juste un signe.',
    'notif.reply_cta': 'Dire que je vais bien',
    'notif.reply_sending': 'Envoi',
    'notif.reply_done': 'La personne a été prévenue.',
    'notif.reply_by': '{who} va bien',
    'notif.reply_anon': 'Tout va bien de son côté',
    'notif.reply_sub': 'La personne a vu que tu prenais de ses nouvelles.',
    ...
    'week.n_events_one': '{n} chose prévue', 'week.n_events_other': '{n} choses prévues',
    'week.n_goals_one': '{n} objectif à rendre', 'week.n_goals_other': '{n} objectifs à rendre',
    'week.mark_cycle': 'jour de cycle',
    'week.cycle_period': 'Règles, premiers jours',
    'week.cycle_predicted': 'Règles prévues',
    'week.cycle_pms': 'Les jours d’avant',
    'week.cycle_fertile': 'Fenêtre fertile',
    ...
    'goal.backfill_hint': 'Touche un jour passé pour l’ajouter, ou re-touche pour le retirer.',
    'goal.mark_on': 'Marquer {date}',
    'settings.sticker_change': 'Changer l’image',
    'settings.sticker_close': 'Terminé',
    'settings.sticker_auto': 'Choisir pour moi',
    'settings.sticker_pick': 'Choisir {name}',
    'settings.sticker_pending': 'Il faut passer la migration 66 avant de pouvoir enregistrer une image.',
    ...
    'water.of': 'sur {total}',
    'update.now': 'Passer à la nouvelle version',
    ...
    'courses.title': 'Cours',
    'courses.sub': 'L’argent, enseigné dans l’ordre où on l’apprend vraiment.',
    ...
    'me.water_off': 'Le rappel d’eau est éteint, donc rien n’est compté. L’allumer pose un compteur de verres ici et sur ton accueil.',
    'me.water_turn_on': 'Allumer le rappel d’eau',
    ...
    'library.guest_paid_title': 'Payé. Ton livre t’attend.',
    'library.guest_paid_body': 'Crée ton compte avec la même adresse courriel que celle du paiement, et le livre s’ouvre tout de suite. Il est gardé sur cette adresse en attendant.',
    'library.guest_paid_cta': 'Créer mon compte',
