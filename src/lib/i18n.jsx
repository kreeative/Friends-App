...
const STRINGS = {
  en: {
    ...
    'settings.when_everywhere': 'Same moment for everyone. That is {when} in the group’s own zone ({tz}).',
  ...
  fr: {
    ...
    'settings.when_everywhere': 'Même moment pour tout le monde. C’est {when} dans le fuseau du groupe ({tz}).',
