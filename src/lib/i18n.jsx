...
const STRINGS = {
  en: {
    ...
    'txn.emotions': 'Émotion(s)',
    'txn.history': 'See the history',
    'txn.history_loading': 'Loading…',
    'txn.history_empty': 'Nothing yet. Changes to this transaction will show up here.',
    'txn.history_unavailable': 'History is not set up on this database yet.',
    'txn.log_created': 'Created',
    'txn.log_updated': 'Modified',
    'txn.log_deleted': 'Deleted',
    'txn.log_change': '{field}: {from} → {to}',
    'txn.log_nothing': 'nothing',
    'txn.log_yes': 'yes',
    'txn.log_no': 'no',
    'txn.field_amount_cents': 'Amount',
    'txn.field_kind': 'Direction',
    'txn.field_category': 'Category',
    'txn.field_note': 'Note',
    'txn.field_happened_on': 'Date',
    'txn.field_excluded': 'Left out of the budget',
    'txn.field_emotions': 'Emotions',

    'emo.group_everyday': 'Everyday',
    'emo.group_positive': 'Good to spend',
    'emo.group_strain': 'Impulse and strain',
    'emo.neutral': 'Neutral',
    'emo.unsure': 'Not sure',
    'emo.routine': 'Routine',
    'emo.pleasure': 'Felt good',
    'emo.calm': 'Needed it',
    'emo.celebration': 'Celebration',
    'emo.gift': 'Gift',
    'emo.selfcare': 'Self care',
    'emo.impulse': 'Impulse',
    'emo.stress': 'Stress',
    'emo.craving': 'Craving',
    'emo.tired': 'Too tired',
    'emo.frustration': 'Frustration',
    'emo.insights': 'Spending by feeling',
    'emo.clear': 'Show all',
    'emo.count_one': '{n} transaction',
    'emo.count_other': '{n} transactions',
    'emo.filtered_one': '{n} transaction with this feeling.',
    'emo.filtered_other': '{n} transactions with this feeling.',
    'emo.none_match': 'Nothing in this period carries that feeling.',
    'txn.save': 'Save',
    'txn.saving': 'Saving',
  ...
  fr: {
    ...
    'txn.emotions': 'Émotion(s)',
    'txn.history': 'Voir l’historique',
    'txn.history_loading': 'Chargement…',
    'txn.history_empty': 'Rien pour l’instant. Les modifications de cette transaction apparaîtront ici.',
    'txn.history_unavailable': 'L’historique n’est pas encore installé sur cette base.',
    'txn.log_created': 'Créée',
    'txn.log_updated': 'Modifiée',
    'txn.log_deleted': 'Supprimée',
    'txn.log_change': '{field} : {from} → {to}',
    'txn.log_nothing': 'rien',
    'txn.log_yes': 'oui',
    'txn.log_no': 'non',
    'txn.field_amount_cents': 'Montant',
    'txn.field_kind': 'Sens',
    'txn.field_category': 'Catégorie',
    'txn.field_note': 'Remarque',
    'txn.field_happened_on': 'Date',
    'txn.field_excluded': 'Exclue du budget',
    'txn.field_emotions': 'Émotions',

    'emo.group_everyday': 'Neutre et quotidien',
    'emo.group_positive': 'Positif et gratifiant',
    'emo.group_strain': 'Impulsion et stress',
    'emo.neutral': 'Neutre',
    'emo.unsure': 'Pas trop sûr',
    'emo.routine': 'Routine',
    'emo.pleasure': 'Fait plaisir',
    'emo.calm': 'Nécessaire',
    'emo.celebration': 'Célébration',
    'emo.gift': 'Cadeau',
    'emo.selfcare': 'Soin personnel',
    'emo.impulse': 'Impulsif',
    'emo.stress': 'Stress',
    'emo.craving': 'Compulsion',
    'emo.tired': 'Fatigue',
    'emo.frustration': 'Frustration',
    'emo.insights': 'Dépenses par émotion',
    'emo.clear': 'Tout afficher',
    'emo.count_one': '{n} transaction',
    'emo.count_other': '{n} transactions',
    'emo.filtered_one': '{n} transaction avec cette émotion.',
    'emo.filtered_other': '{n} transactions avec cette émotion.',
    'emo.none_match': 'Rien dans cette période ne porte cette émotion.',
