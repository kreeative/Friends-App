...
const STRINGS = {
  en: {
    ...
    'money.card_rule_title': 'Paying by credit card? Read this',
    'money.card_rule_1': 'Log what you actually buy, on the day you buy it. Fifty dollars of groceries on the card on 2 August goes in as fifty dollars of food on 2 August, in its own category.',
    'money.card_rule_2': 'Do NOT log the card repayment. Sending a hundred dollars from your bank to clear the card on 3 August is not a new expense: that money already left when you bought the groceries. Log it as well and you count the same money twice.',
    'money.card_rule_3': 'If the card payment is one of your fixed charges, just tap Payer on it here. That writes the transaction for you, so do not add it again by hand.',
    ...
    'form.finished': 'You have read all six.',
  ...
  fr: {
    ...
    'money.card_rule_title': 'Tu payes par carte de crédit ? Lis ça',
    'money.card_rule_1': 'Enregistre tes achats réels, le jour même. Cinquante dollars d’épicerie avec la carte le 2 août, c’est cinquante dollars de nourriture le 2 août, dans sa catégorie.',
    'money.card_rule_2': 'N’enregistre PAS le remboursement de la carte. Le virement de cent dollars de ton compte vers la carte le 3 août n’est pas une nouvelle dépense : cet argent est déjà parti quand tu as fait l’épicerie. Si tu l’ajoutes aussi, tu comptes le même argent deux fois.',
    'money.card_rule_3': 'Si le paiement de la carte est une de tes charges fixes, appuie simplement sur Payer ici. La transaction est écrite pour toi, donc ne la rajoute pas à la main.',
    ...
    'form.finished': 'Tu as lu les six.',
