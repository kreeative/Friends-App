...
const STRINGS = {
  en: {
    ...
    'peers.median': 'Among those who do save, the median is {amount} a month.',
    'peers.method': 'Survey of {n} young people, median age {age}, August 2026. Self-reported amounts, not a national statistic.',
  ...
  fr: {
    ...
    'peers.median': 'Chez ceux qui épargnent, la médiane est {amount} par mois.',
    'peers.method': 'Sondage de {n} jeunes, âge médian {age} ans, août 2026. Montants déclarés, pas une statistique nationale.',
    'bm.c_CI': 'Côte d’Ivoire',
