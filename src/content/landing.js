...
export const LANDING = {
  en: {
    ...
    studies: {
      ...
      read: 'Read the study',
      home_line: 'The figures we use for young Ivorians come from our own survey, not from an estimate. It is published in full, with the method and the limits.',
      home_link: 'See the study',
      back: 'All studies',
      ...
      dots_note: 'The same 92 people, lit up on 3 different questions. The tool is there, the wanting is there, the saving does not follow.',
      dots_app: 'Has an app',
    ...
    footer: {
      ...
      home: 'Home',
      menu: 'Menu',
      links: { how: 'How it works', about: 'About', library: 'The books', studies: 'Studies', faq: 'Help', credits: 'Thank you', signin: 'Sign in', join: 'Join the movement' },
      legalHeading: 'Legal',
      contact: 'Contact',
  ...
  fr: {
    ...
    studies: {
      ...
      read: 'Lire l’étude',
      home_line: 'Les chiffres qu’on utilise pour les jeunes Ivoiriens viennent de notre propre sondage, pas d’une estimation. Il est publié en entier, avec la méthode et les limites.',
      home_link: 'Voir l’étude',
      ...
      dots_note: 'Les mêmes 92 personnes, éclairées sur 3 questions différentes. L’outil est là, l’envie est là, l’épargne ne suit pas.',
