...
export const GLOSSARY = {
  ...
  inflation: {
    ...
    match: { fr: 'inflation', en: 'inflation' },
  },
  'interets-composes': {
    ...
    match: { fr: 'int[ée]r[êe]ts compos[ée]s', en: 'compound(?:ing| interest)' },
  },
  'cout-d-opportunite': {
    ...
    match: { fr: 'co[ûu]t d\'opportunit[ée]', en: 'opportunity cost' },
  },
  ...
  dividende: {
    ...
    match: { fr: 'dividendes?', en: 'dividends?' },
  },
  fnb: {
  ...
  indice: {
    ...
    match: { fr: 'indiciels?', en: 'index funds?' },
  },
  diversification: {
    ...
    match: { fr: 'diversification', en: 'diversification' },
  },
  'frais-de-gestion': {
    ...
    match: { fr: 'frais de gestion', en: 'management fees?' },
  },
  volatilite: {
    ...
    match: { fr: 'volatilit[ée]', en: 'volatility' },
  },
  'marche-baissier': {
    ...
    match: { fr: 'march[ée] baissier', en: 'bear market' },
  },
  rendement: {
    ...
    match: { fr: 'rendements?', en: 'returns?' },
  },
  'achat-periodique': {
    ...
    match: { fr: 'achat p[ée]riodique', en: 'dollar-cost averaging' },
  },
  ...
  symbole: {
    ...
    match: { fr: 'symbole|ticker', en: 'ticker' },
  },
  'ordre-au-marche': {
    ...
    match: { fr: 'ordre au march[ée]', en: 'market order' },
  },
  'ordre-a-cours-limite': {
    ...
    match: { fr: 'ordre [àa] cours limit[ée]', en: 'limit order' },
  },
  'compte-non-enregistre': {
    ...
    match: { fr: 'compte ordinaire', en: 'taxable account' },
  },
  'plafond-de-cotisation': {
    ...
    match: { fr: 'plafond de cotisation|droits de cotisation', en: 'contribution room' },
  },
  celi: {
  ...
  'assurance-vie': {
    ...
    match: { fr: 'assurance-vie', en: 'assurance-vie' },
    only: ['fr'],
  },
  '401k': {
  ...
  'limite-de-credit': {
    ...
    match: { fr: 'limite de cr[ée]dit', en: 'credit limit' },
  },
  solde: {
  ...
  releve: {
    ...
    match: { fr: 'relev[ée]', en: 'statement' },
  },
  'delai-de-grace': {
    ...
    match: { fr: 'd[ée]lai de gr[âa]ce', en: 'grace period' },
  },
  'paiement-minimum': {
    ...
    match: { fr: 'paiement minimum', en: 'minimum payment' },
  },
  'taux-annuel': {
    ...
    match: { fr: 'taux annuel|TAP|APR', en: 'annual rate|APR' },
  },
  'interet-quotidien': {
    ...
    match: { fr: 'int[ée]r[êe]ts? quotidiens?', en: 'daily interest' },
  },
  'avance-de-fonds': {
    ...
    match: { fr: 'avance de fonds', en: 'cash advance' },
  },
  'frais-de-conversion': {
    ...
    match: { fr: 'frais de conversion', en: 'foreign transaction fee' },
  },
  'frais-annuels': {
    ...
    match: { fr: 'frais annuels', en: 'annual fee' },
  },
  'cote-de-credit': {
    ...
    match: { fr: 'cote de cr[ée]dit', en: 'credit score' },
  },
  'historique-de-credit': {
    ...
    match: { fr: 'historique de cr[ée]dit', en: 'credit history' },
  },
  'taux-utilisation': {
    ...
    match: { fr: 'taux d\'utilisation', en: 'utilisation' },
  },
  'enquete-de-credit': {
    ...
    match: { fr: 'enqu[êe]te de cr[ée]dit', en: 'hard inquiry' },
  },
  'transfert-de-solde': {
    ...
    match: { fr: 'transfert de solde', en: 'balance transfer' },
  },
  'methode-avalanche': {
    ...
    match: { fr: 'avalanche', en: 'avalanche' },
  },
  'methode-boule-de-neige': {
    ...
    match: { fr: 'boule de neige', en: 'snowball' },
  },
  ...
  'revenu-brut': {
    ...
    match: { fr: 'revenu brut', en: 'gross income' },
  },
  'revenu-net': {
    ...
    match: { fr: 'revenu net', en: 'net income' },
  },
  'depense-fixe': {
    ...
    match: { fr: 'd[ée]penses? fixes?', en: 'fixed costs?' },
  },
  'depense-variable': {
    ...
    match: { fr: 'd[ée]penses? variables?', en: 'variable costs?' },
  },
  'budget-base-zero': {
    ...
    match: { fr: 'budget [àa] base z[ée]ro', en: 'zero-based budget' },
  },
  enveloppe: {
    ...
    match: { fr: 'enveloppes?', en: 'envelopes?' },
  },
  'taux-epargne': {
    ...
    match: { fr: 'taux d\'[ée]pargne', en: 'savings rate' },
  },
  'fonds-urgence': {
    ...
    match: { fr: 'fonds d\'urgence', en: 'emergency fund' },
  },
  'valeur-nette': {
    ...
    match: { fr: 'valeur nette', en: 'net worth' },
  },
  taxes: {
    term: { fr: 'Impôts et taxes', en: 'Tax' },
    short: {
      fr: 'La part de ton revenu et de tes gains que l’État prélève. Elle décide souvent du compte à ouvrir avant même du placement à choisir.',
      en: 'The share of your income and gains the state takes. It often decides which account to open before it decides what to invest in.',
    },
    match: { fr: 'imp[ôo]ts?|taxes?|imposable', en: 'taxe?s?|taxable|income tax' },
  },
  'gain-en-capital': {
    term: { fr: 'Gain en capital', en: 'Capital gain' },
    short: {
      fr: 'La différence entre ce que tu as payé et ce que tu revends. Il n’existe pas tant que tu n’as pas vendu, et il n’est imposé qu’à ce moment-là.',
      en: 'The difference between what you paid and what you sell for. It does not exist until you sell, and it is taxed only then.',
    },
    match: { fr: 'gain en capital|gains en capital', en: 'capital gains?' },
  },
  'lump-sum': {
    term: { fr: 'Investir d’un coup', en: 'Lump sum' },
    short: {
      fr: 'Placer toute la somme en une fois, au lieu de l’étaler sur plusieurs mois. Statistiquement gagnant, et plus dur à vivre si le marché baisse la semaine suivante.',
      en: 'Investing the whole amount at once instead of spreading it over months. Statistically the winner, and harder to live through if the market falls the week after.',
    },
    match: { fr: 'd\'un coup', en: 'lump sum' },
  },
}
