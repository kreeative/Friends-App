Almost every piece of advice you have been given about confidence has the arrow pointing the wrong way.
...
That is the first entry in the file. It will not feel like much. It is not supposed to; single data points never do. But this is the only mechanism that has ever reliably worked, and the ledger is the difference between doing things and knowing that you have done them.
